...
<li><a class="blue-text" href="editprofile">Modifier</a></li>
<li><a class="blue-text" href="includes/logout">déconnecter</a></li>
</ul>
<div class="navbar-fixed">
 <nav class="navblack">
   ...
   <ul class="left hide-on-med-and-down">
     ...
     <li><a href="index" class="dark-text">Cour a bois</a></li>
   ...
   <ul  class="right hide-on-med-and-down">
       <li><a href="index" class="dark-text">Accueil</a></li>
