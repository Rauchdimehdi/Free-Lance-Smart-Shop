<?php
 ...
 if (isset($_POST['pay'])) {
    ...
    $querycmd ="SELECT product.id,
                       ...
                       FROM product, command, utilisateurs
                       WHERE product.id = command.id_produit AND utilisateurs.id = command.id_user
       ...
       <nav>
         <div class="nav-wrapper">
           <div class="col s12">
             ...
             <a href="final" class="breadcrumb">Merci <3 </a>
           </div>
         </div>
       </nav>
     </div>
...
<div class="container thanks">
  ...
  <div class="card center-align">
     ...
     <div class="card-content center-align">
       <h5>Merci pour votre achât</h5>
       <p>votre commande a été expédiée : <h5 class="green-text"><?php echo"$firstname_sess". " " . "$lastname_sess";  ?></h5></p>
     </div>
   </div>

   <div class="center-align">
     <a href="details.php" class="button-rounded blue btn waves-effects waves-light">Details</a>
     <a href="index" class="button-rounded btn waves-effects waves-light">Accueil</a>
   </div>
  </div>
  <div class="col s12 m3">
