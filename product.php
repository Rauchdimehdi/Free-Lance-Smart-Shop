      ...
      <nav>
        <div class="nav-wrapper">
          <div class="col s12">
            ...
            <a href="product.php?id=<? $id_product; ?>" class="breadcrumb">Produit</a>
          </div>
        </div>
      </nav>
    </div>
   ...
   <div class="row">
     <div class="col s12 m6">
       ...
       <div class="row">
         ...
         //get categories
           $querypic = "SELECT picture, id_produit FROM images WHERE id_produit = '$id_pic'";
     ...
     <div class="col s12 m6">
       ...
       <div class="center-align">
           <button type="submit" name="buy" class="btn-large meh button-rounded waves-effect waves-light ">Ajouter au panier </button>
       </div>
       </div>
        </form>
     </div>
